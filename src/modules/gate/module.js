...
// button (or spacebar). Gate is event-based, dispatched by the engine's
// _gateConnections map. The panel calls engine.emitGate(...) directly; the
// module itself holds no Web Audio nodes.
