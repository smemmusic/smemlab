...
// CV Mixer panel: 4 channel strips (knob + phase toggle) and a master knob.
// All params live in the module's `params` bag; setModuleParam dispatches
// through the bridge to the audio side.
